...
def categories_of_operations(operations: list, list_of_categories: list) -> dict:
    ...
    for operation in operations:
        ...
        if description in operation_counter or description in list_of_categories:
            operation_counter[description] += 1

    category_count = {category: operation_counter.get(category, 0) for category in list_of_categories}

    return category_count


print(categories_of_operations(operations, list_of_categories))
